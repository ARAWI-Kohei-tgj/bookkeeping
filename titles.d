 ...
 * 勘定科目の一覧
 *************************************************************/
immutable string[154] accountTitles;
...
shared static this(){
  accountTitles[]= () @safe pure nothrow @nogc{
    const string[154] dummy= [
      ...
      "支払報酬", "減価償却費", "開発費償却", "地代家賃",
      "支払保険料", "諸会費", "寄附金", "貸倒引当金繰入額",
      "雑費", "種苗費", "素畜費", "肥糧費",
      "飼糧費", "農薬費", "敷料費", "燃油費",
      "諸材料費", "賃金手当", "作業用衣料費", "作業委託費",
      "診療衛生費", "預託費", "ヘルパー利用費", "圃場管理費",
      "農具費", "修繕費", "動力光熱費", "共済掛金",
      "とも補償拠出金", "農地賃借料", "地代賃借料", "土地改良費",
      "租税公課（一般管理費分）", "租税公課（製造経費分）", "支払利息", "手形譲渡損",
      "廃畜処分損", "雑損失", "固定資産売却損", "固定資産除却損",
      "固定資産圧縮損", "災害損失", "特別償却費", "給料手当",
      "雑給", "賞与", "退職金", "退職給付費用",
      "法定福利費", "福利厚生費",
      "期首材料棚卸高", "期末材料棚卸高"];
    return dummy;
